export const oldTestament = {
  ...
  "Livros históricos": [
    ...
    "1 Reis", "2 Reis", "1 Crônicas", "2 Crônicas", "Esdras", "Neemias", "Ester",
  ],
...
export const chapterCounts = {
  ...
  "Esdras": 10, "Neemias": 13, "Ester": 10,
  // Poéticos
  "Jó": 42, "Salmos": 150, "Provérbios": 31, "Eclesiastes": 12, "Cantares": 8,
  // Profetas maiores
  "Isaías": 66, "Jeremias": 52, "Lamentações": 5, "Ezequiel": 48, "Daniel": 12,
  // Profetas menores
  "Oséias": 14, "Joel": 3, "Amós": 9, "Obadias": 1, "Jonas": 4, "Miquéias": 7,
